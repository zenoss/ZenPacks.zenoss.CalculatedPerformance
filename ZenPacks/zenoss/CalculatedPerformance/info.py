...
from ZenPacks.zenoss.CalculatedPerformance.datasources \
...
from ZenPacks.zenoss.CalculatedPerformance.interfaces import (
    IAggregatingDataSourceInfo, IElementPoolInfo, IAggregatingDataPointInfo,
    ICalculatedPerformanceDataSourceInfo)
...
class ElementPoolInfo(ComponentInfo):
    ...
    def _loadMembers(self):
        if self._members is None:
            self._members = [
                IInfo(obj) for obj in self._object.getElements()]
